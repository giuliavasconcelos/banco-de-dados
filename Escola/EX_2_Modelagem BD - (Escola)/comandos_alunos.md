...
FROM alunos WHERE data_de_nascimento < '2009-01-01';

ou

SELECT nome,data_de_nascimento 
FROM alunos WHERE YEAR(data_de_nascimento) < 2009;
...
SELECT alunos.nome, cursos.titulo FROM alunos INNER JOIN cursos ON alunos.curso_id = cursos.id;
...
SELECT professores.nome, cursos.titulo FROM professores INNER JOIN cursos ON alunos.curso_id = cursos.id;
